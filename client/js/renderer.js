...
function(Camera, Item, Character, Player, Timer) {
    ...
    var Renderer = Class.extend({
        ...
        drawTreasureBalance: function() {
          ...
          this.context.save();
          var treasureBalance = this.game.sprites['treasurebalance'];
          if(treasureBalance && treasureBalance.isLoaded) {
              this.context.drawImage(treasureBalance.image, 0, 0, 24 * os, 24 * os, mx, my, 24*s, 24*s);
          }
          var color = "#ffdc79";
          this.setFontSize(24);
